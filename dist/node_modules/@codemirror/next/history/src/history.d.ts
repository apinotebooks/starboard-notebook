import { EditorState, Transaction, StateCommand, StateEffect, Facet, Extension } from "@codemirror/next/state";
import { KeyBinding } from "@codemirror/next/view";
export declare const isolateHistory: import("@codemirror/next/state").AnnotationType<"full" | "before" | "after">;
