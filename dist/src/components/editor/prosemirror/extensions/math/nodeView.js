...
export class MathView {
    ...
    openEditor() {
            ...
            state: EditorState.create({
                ...
                plugins: [keymap({
                        ...
                        "Ctrl-Enter": (state, dispatch) => {
                            ...
                            this._outerView.dispatch(outerState.tr.setSelection(TextSelection.create(outerState.doc, to)));
        ...
        this._innerView.dispatch(innerState.tr.setSelection(TextSelection.create(innerState.doc, pos)));
