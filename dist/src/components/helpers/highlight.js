...
export function hookMarkdownItToPrismHighlighter(markdownItInstance) {
     ...
     * runtime too.
     */
    const markdownItThatHasOptions = markdownItInstance;
    ...
    markdownItThatHasOptions.options.highlight = (...args) => {
        if (globalThis.Prism.languages[args[1]] === undefined) {
            args[1] = "clike";
        }
