...
export class JavascriptConnectorCellHandler extends BaseCellHandler {
    ...
    async run() {
        ...
        var iframe:any = html`<iframe src="https://components.adenin.com/components/at-card-preview/loader.html?data=${crushed}" style="width:100%;height:750px;">`;
